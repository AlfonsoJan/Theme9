...
```{r}
weka.result <- read.table("Result.csv", header = TRUE, sep = ",")
...
ggplot(data=res, aes(x=Key_Scheme, y=Area_under_ROC, fill=Key_Scheme)) + 
  ...
  geom_text(aes(label=round(Area_under_ROC, digits=2)), vjust=-0.3, size=3.5)
```
